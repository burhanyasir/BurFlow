  ...
  return (
    <Container className="py-8">
      <header className="mb-8">
        <h1 className="text-4xl font-bold text-[var(--color-neutral-900)] mb-2">Design System</h1>
        <p className="text-lg text-[var(--color-neutral-500)]">Component library and UI patterns (dev reference)</p>
      </header>
      ...
      <footer className="mt-16 pt-8 border-t border-[var(--color-neutral-200)] text-center text-sm text-[var(--color-neutral-300)]">
        Conversation Engine &copy; {new Date().getFullYear()} &mdash; Design System Reference
      </footer>
    </Container>
  );
}
