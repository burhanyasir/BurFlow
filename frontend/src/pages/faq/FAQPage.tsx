...
const faqItems: AccordionItem[] = [
  { id: 'hallucination', trigger: 'How does BurFlow prevent incorrect or hallucinated answers?', content: 'BurFlow restricts responses strictly to the contents of your published Knowledge Bases. If a visitor inquiry falls outside your source material, the widget returns a custom offline fallback response rather than generating speculative answers.' },
  ...
  { id: 'branding', trigger: 'Can we remove all BurFlow branding?', content: 'Yes. Professional and Enterprise tiers include complete white-label customization. You can adjust theme colors, upload custom icons, modify messaging, and disable platform attribution completely.' },
