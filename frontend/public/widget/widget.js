...
var BurFlowWidget = (() => {
  ...
  var DEFAULT_CONFIG = {
    ...
    subtitle: "AI assistant \xB7 Online",
    primaryColor: "#006248",
    avatarUrl: void 0,
  ...
  var ChatWidget = class {
    constructor(config) {
      ...
      __publicField(this, "businessProfile", {});
      __publicField(this, "isOpen", false);
      __publicField(this, "isStreaming", false);
      __publicField(this, "abortController", null);
      __publicField(this, "container", null);
      __publicField(this, "messagesEl", null);
      __publicField(this, "inputEl", null);
      __publicField(this, "sendBtnEl", null);
      __publicField(this, "bubbleEl", null);
      __publicField(this, "headerTitleEl", null);
      __publicField(this, "headerSubtitleEl", null);
      __publicField(this, "unreadCount", 0);
      __publicField(this, "actionPanel", null);
      __publicField(this, "uiState", null);
      __publicField(this, "cta", null);
      __publicField(this, "unreadBadge", null);
      __publicField(this, "preOpenPanelEl", null);
      __publicField(this, "configLoadPromise", null);
      __publicField(this, "suggestionHistory", []);
      __publicField(this, "preOpenDismissed", false);
      __publicField(this, "handoffEl", null);
      __publicField(this, "handoffShown", false);
      __publicField(this, "takeoverEl", null);
      __publicField(this, "takeoverShown", false);
      __publicField(this, "placeholderInterval", null);
      __publicField(this, "autoOpenTimer", null);
      __publicField(this, "headerLogoEl", null);
      /** The primaryColor from the embed data-attribute — preserved over remote config. */
      __publicField(this, "embedPrimaryColor", null);
      /** Long-lived SSE stream of takeover events (TAKEOVER_STARTED / OPERATOR_MESSAGE / TAKEOVER_ENDED). */
      __publicField(this, "takeoverEventsController", null);
      /** Polls GET /api/chat/history for operator messages during a human takeover. */
      __publicField(this, "agentPollTimer", null);
      __publicField(this, "lastAgentSeq", 0);
      __publicField(this, "boundDismissPreOpen", (e) => {
    ...
    renderPreOpenOptions() {
      ...
      options.forEach((text, i) => {
        ...
        row.addEventListener("mouseenter", () => {
          ...
          pill.style.transform = "translateX(3px)";
        });
    ...
    createHeader() {
      ...
      subtitle.textContent = this.config.subtitle || "AI assistant \xB7 Online";
    ...
    createInputArea() {
      ...
      footer.innerHTML = '<span style="font-size:10px;color:#9CA3AF;letter-spacing:0.02em;">Answers from this website \xB7 Powered by <b style="color:#006248;">BurFlow</b></span>';
