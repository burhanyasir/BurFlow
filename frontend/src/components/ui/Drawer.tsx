        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--color-neutral-200)]">
              {title && <h2 className="text-lg font-semibold text-[var(--color-neutral-900)]">{title}</h2>}
              <button onClick={onClose} className="p-1 rounded-md text-[var(--color-neutral-500)] hover:text-[var(--color-neutral-900)] hover:bg-[var(--color-neutral-50)] transition-colors" aria-label="Close drawer">
