...
export const PADDLE_TIERS: PaddleTierConfig[] = [
  {
    ...
    monthly: {
      ...
      countryOverrides: [...gbp('800'), ...eur('900'), ...aud('1500')],
    },
    yearly: {
      interval: 'year',
      amount: '10000',
      ...
      trialDays: PADDLE_TRIAL_DAYS,
      countryOverrides: [...gbp('8000'), ...eur('9000'), ...aud('15000')],
    },
  ...
  },
  {
    ...
    monthly: {
      ...
      trialDays: PADDLE_TRIAL_DAYS,
      countryOverrides: [...gbp('3200'), ...eur('3600'), ...aud('6000')],
    },
    yearly: {
      interval: 'year',
      amount: '40000',
      ...
      trialDays: PADDLE_TRIAL_DAYS,
      countryOverrides: [...gbp('32000'), ...eur('36000'), ...aud('60000')],
    },
