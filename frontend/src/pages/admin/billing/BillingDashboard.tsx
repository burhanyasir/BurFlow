...
const DEFAULT_PLANS: Plan[] = [
  ...
  { id: 'starter', name: 'Starter', price: 29, priceYearly: 278, currency: 'usd', interval: 'mo', trialDays: 7, features: ['3,000 conversations per month', '50 documents', '5 knowledge bases', '5 team members', 'Email support'], limits: { conversations: 3000, documents: 50, knowledgeBases: 5, teamMembers: 5, apiCalls: 5000, storageMb: 500, widgets: 3, analytics: true, customBranding: false, prioritySupport: false } },
  { id: 'pro', name: 'Pro', price: 49, priceYearly: 470, currency: 'usd', interval: 'mo', trialDays: 7, features: ['10,000 conversations per month', '200 documents', '20 knowledge bases', '20 team members', 'Advanced analytics', 'Custom branding', 'Priority support'], limits: { conversations: 10000, documents: 200, knowledgeBases: 20, teamMembers: 20, apiCalls: 25000, storageMb: 2000, widgets: 10, analytics: true, customBranding: true, prioritySupport: true } },
  { id: 'advanced', name: 'Advanced', price: 99, priceYearly: 950, currency: 'usd', interval: 'mo', trialDays: 7, features: ['25,000 conversations per month', '1,000 documents', '50 knowledge bases', '50 team members', 'White-label branding', 'Dedicated support', 'SSO & SLA'], limits: { conversations: 25000, documents: 1000, knowledgeBases: 50, teamMembers: 50, apiCalls: 250000, storageMb: 10000, widgets: 50, analytics: true, customBranding: true, prioritySupport: true } },
];
